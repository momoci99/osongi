...
import {
  ...
  buildRawRowsCsv,
  buildSeriesCsv,
} from "../../../utils/analysisQuery/exportData";
...
const ExportMenu = ({ query, result, chartAreaRef }: ExportMenuProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        <MenuItem onClick={() => run(() => downloadCsv(buildRawRowsCsv(result.rows), `${filename}_raw`))}>
